...
<body>
    ...
    <div class="admin-container">
        <h2>Manage Events</h2>
        <a href="admin_event_create.php" class="btn-create">Add New Event</a>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="event.php?id=<?= $event['id'] ?>" class="btn-action btn-edit" style="background-color: #2196F3;" target="_blank">View</a>
                        <a href="admin_event_edit.php?id=<?= $event['id'] ?>" class="btn-action btn-edit">Edit</a>
                        <a href="admin_events.php?delete_id=<?= $event['id'] ?>" class="btn-action btn-delete" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
