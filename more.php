...
$stmt = $conn->query("SELECT * FROM events ORDER BY event_date");
...
<head>
    ...
    <title>More Events | TicketGeek</title>
...
<body>
    ...
    <div class="content-wrapper">
        <section class="hero" style="background: linear-gradient(rgba(10, 10, 35, 0.6), rgba(10, 10, 35, 0.6)), url('https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=1200&h=500&fit=crop') center/cover;">
            <h2>All Events</h2>
        ...
        <div class="left-genres">
            <div class="event-row">
                <h2 class="section-title" style="text-align: center;">All Upcoming Events</h2>
                <?php if (empty($events)): ?>
