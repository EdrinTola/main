...
$stmt = $conn->query("SELECT * FROM events WHERE 
    title LIKE '%Taylor Swift%' OR 
    title LIKE '%Coldplay%' OR 
    title LIKE '%Weeknd%' OR 
    title LIKE '%Sheeran%' OR 
    title LIKE '%Adele%' OR 
    title LIKE '%Imagine Dragons%' OR 
    title LIKE '%Youngboy%' OR 
    title LIKE '%concert%' OR 
    title LIKE '%tour%' OR
    title LIKE '%Tour%'
    ORDER BY event_date");
...
<head>
    ...
    <title>Concerts | TicketGeek</title>
...
<body>
    ...
    <div class="content-wrapper">
        <section class="hero" style="background: linear-gradient(rgba(10, 10, 35, 0.6), rgba(10, 10, 35, 0.6)), url('https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=1200&h=500&fit=crop') center/cover;">
            <h2>Concerts</h2>
        ...
        <div class="left-genres">
            <div class="event-row">
                <h2 class="section-title" style="text-align: center;">Upcoming Concerts</h2>
                <?php if (empty($events)): ?>
